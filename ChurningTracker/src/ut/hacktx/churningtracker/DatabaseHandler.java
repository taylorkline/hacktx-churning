...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String KEY_MONEY_SPENT = "money_spent";
    ...
    void addContact(Contact contact) {
        ...
        values.put(KEY_MONEY_SPENT, contact.getPhoneNumber()); // Contact Phone
    ...
    public int updateContact(Contact contact) {
        ...
        values.put(KEY_MONEY_SPENT, contact.getPhoneNumber());
